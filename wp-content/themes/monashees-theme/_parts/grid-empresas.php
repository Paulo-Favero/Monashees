<section class="grid-empresas ">
	...
	<div class="content_empresas" role="document">
		...
		<div class="busca-empresas">
			...
			<div class="box-filtros">
				<label>
					...
					<select id="select-segmentos" class="selectpicker">
				...
				<label>
					...
					<select id="select-pais" class="selectpicker">
			...
			<div class="itens">
				...
				<?php if ($empreendedores): ?>
					...
					<?php
						...
						// echo mo_categoria_slug('segmento', $empreendedor->ID );
					?>
					<div data-scroll="no" data-grid="true" data-empresa="<?php echo $empreendedor->ID; ?>" data-carreira="<?php echo $_GET['lang']; ?>" class="item btn-open-empresa <?php mo_categoria_slug('segmento', $empreendedor->ID); ?> <?php  mo_categoria_slug('pais', $empreendedor->ID); ?>" style="background-image: url('<?php echo $logo['url']; ?>'); ">
